...
PROCESS(temp_control_coap, "Temp Control CoAP Server");
AUTOSTART_PROCESSES(&temp_control_coap);

PROCESS_THREAD(temp_control_coap, ev, data)
{
  PROCESS_BEGIN();

  PROCESS_PAUSE();

  PRINTF("Starting Temp Control CoAP Server\n");
